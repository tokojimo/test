export default {
  ...
  "Se connecter avec Google": { fr: "Se connecter avec Google", en: "Sign in with Google" },
  "Se connecter avec Apple": { fr: "Se connecter avec Apple", en: "Sign in with Apple" },
  "Créer un compte avec Google": { fr: "Créer un compte avec Google", en: "Sign up with Google" },
  "Créer un compte avec Apple": { fr: "Créer un compte avec Apple", en: "Sign up with Apple" },
  ...
  "Modifier la cueillette": { fr: "Modifier la cueillette", en: "Edit harvest" },
  "Date": { fr: "Date", en: "Date" },
  "Commentaire": { fr: "Commentaire", en: "Comment" },
  "Supprimer cette cueillette ?": { fr: "Supprimer cette cueillette ?", en: "Delete this harvest?" },
  ...
  "Prévisions locales": { fr: "Prévisions locales", en: "Local forecast" },
  "Insights": { fr: "Aperçus", en: "Insights" },
  ...
  "Carte de l'emplacement situé aux coordonnées latitude {lat}, longitude {lng}": {
    fr: "Carte de l'emplacement situé aux coordonnées latitude {lat}, longitude {lng}",
    en: "Map of the location at latitude {lat}, longitude {lng}",
  },
  "© OpenStreetMap contributors | MapLibre": {
    fr: "© OpenStreetMap contributors | MapLibre",
    en: "© OpenStreetMap contributors | MapLibre",
  },
  "Cueillettes": { fr: "Cueillettes", en: "Harvests" },
  "Cueillette du {date}": { fr: "Cueillette du {date}", en: "Harvest on {date}" },
  "Ajouter une cueillette": { fr: "Ajouter une cueillette", en: "Add a harvest" },
  "Aucune cueillette enregistrée.": { fr: "Aucune cueillette enregistrée.", en: "No harvest recorded." },
  "Note:": { fr: "Note:", en: "Rating:" },
  "Galerie": { fr: "Galerie", en: "Gallery" },
  "Photo de la cueillette {n}": { fr: "Photo de la cueillette {n}", en: "Photo of harvest {n}" },
